...
const product_catalog_resolver_1 = require("./product-catalog.resolver");
...
exports.ProductCatalogModule = ProductCatalogModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [product_catalog_resolver_1.ProductCatalogResolver, product_catalog_service_1.ProductCatalogService],
